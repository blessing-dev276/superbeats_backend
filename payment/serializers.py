...
class SubscribeSerializer(serializers.ModelSerializer):
    ...
    def save_attributes(self, obj, data, set_user=False):
        ...
        obj.update({
            ...
            'ended_at': datetime.fromtimestamp(data.ended_at) if data.ended_at else None,
            'cancel_at': datetime.fromtimestamp(data.cancel_at) if data.cancel_at else None,
            'trial_end': datetime.fromtimestamp(data.trial_end) if data.trial_end else None,
            'trial_start': datetime.fromtimestamp(data.trial_start) if data.trial_start else None,
            'period_end': datetime.fromtimestamp(data.current_period_end) if data.current_period_end else None,
            'period_start': datetime.fromtimestamp(data.current_period_start) if data.current_period_start else None,
        })
